...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Credit Note", url: "/app/vouchers/new/credit_note", icon: ReceiptText, i18nKey: "nav.creditNote" },
      { title: "DebitNote", url: "/app/vouchers/new/debit_note", icon: ReceiptText, i18nKey: "nav.debitNote" },
      ...
      { title: "Mfg & Process JV", url: "/app/vouchers/new/manufacturing", icon: Boxes, i18nKey: "nav.manufacturing" },
    ],
  },
  {
    label: "Display / Print",
