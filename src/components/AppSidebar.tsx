...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "CreditNote", url: "/app/vouchers/new/credit_note", icon: ReceiptText, i18nKey: "nav.creditNote" },
      ...
      { title: "StockJournal", url: "/app/vouchers/new/manufacturing", icon: Boxes, i18nKey: "nav.manufacturing" },
    ],
  },
  {
    label: "Display / Print",
